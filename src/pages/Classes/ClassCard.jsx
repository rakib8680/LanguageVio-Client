                ...
                <div className={`card  backdrop-blur-md ${seats ? 'bg-white bg-opacity-20' : 'bg-red-200 cursor-not-allowed border-red-600'} shadow-md border-slate-400 border w-96 p-5 md:p-0 rounded-none`}>
                    ...
                    <div className="card-body pt-3">
                        ...
                        <div className="card-actions justify-end">
                            <button disabled={!seats && true} onClick={handleAddToCart} className=" btn btn-outline rounded-none hover:bg-gradient-to-br from-indigo-100 via-red-100 to-purple-100 hover:text-black px-9">Select</button>
                        </div>
                    </div>
                </div>
            }
